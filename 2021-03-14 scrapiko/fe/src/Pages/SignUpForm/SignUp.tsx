...
const Signup = () => {
  ...
  const signupButton = (e: any) => {
    e.preventDefault()
    console.log('singup button click')
  }
  return (
    <>
      <div className="row signup__container">
        <div className="col-8 container__child signup__thumbnail">
        ...
        <div className="col-4 container__child signup__form">
          <form action="#">
            <div className="form-group">
              <label htmlFor="username">Username</label>
              <input className="form-control" type="text" name="username" id="username" placeholder="Enter your Name " required />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input className="form-control" type="password" name="passwordRepeat" id="passwordRepeat" placeholder="Confirm Password" required />
            </div>
            <div className="m-t-lg">
              <ul className="list-inline">
                ...
                <li>
                  <a className="signup__link" href="/login">I am already a member</a>
                </li>
              </ul>
            </div>
          </form>
